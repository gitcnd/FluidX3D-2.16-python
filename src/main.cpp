...
*/
			...
			draw_label(ox, oy+i, "H ("+string(key_H?" shown  ":" hidden ")+"): show/hide help", c); i+=FONT_HEIGHT;
			draw_label(ox, oy+i, "O ("+string(key_O?" saving ":" paused ")+"): write frames to disk files", c); i+=2*FONT_HEIGHT;
